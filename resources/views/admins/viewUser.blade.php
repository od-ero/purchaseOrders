                      ...
                      <form>
                        <input type="text" value="view" id="action_url" name="action_url" hidden>
                         ...
                         <thead>
                          ...
                          <a class="btn btn-success btn-sm" data-id="{{ base64_encode($user_details['id'])}}" id="update_employees_details" href="#">Update</i></a>
                          @if ($user_details['login_access'] == 1 )
                          <a class="btn btn-danger btn-sm"  data-id="{{ base64_encode($user_details['id'])}}" id="delete_user_button" href="#">Delete</i></a>
                          @endif
                          @if ($user_details['login_access'] == 0 )
                          <a class="btn btn-primary btn-sm" data-id="{{ base64_encode($user_details['id'])}}" id="activate_user_button" href="#">Activate</i></a>
                          @endif
